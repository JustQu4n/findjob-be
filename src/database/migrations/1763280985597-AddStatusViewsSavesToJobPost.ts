...
export class AddStatusViewsSavesToJobPost1763280985597 implements MigrationInterface {
    name = 'AddStatusViewsSavesToJobPost1763280985597'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "job_posts" ADD "views_count" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "job_posts" ADD "saves_count" integer NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_17022daf3f885f7d35423e9971"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_178199805b901ccd220ab7740e"`);
        await queryRunner.query(`ALTER TABLE "job_posts" DROP COLUMN "saves_count"`);
        await queryRunner.query(`ALTER TABLE "job_posts" DROP COLUMN "views_count"`);
