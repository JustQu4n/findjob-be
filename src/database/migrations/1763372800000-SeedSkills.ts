...
export class SeedSkills1763372800000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            ...
            ('FastAPI'), ('Spring Boot'), ('ASP.NET Core'), ('Laravel'),
            ('Ruby on Rails'),
            ...
            ('SQL Server'), ('SQLite'), ('Firebase'), ('DynamoDB'),
            ('Cassandra'), ('Elasticsearch'),
            
            -- DevOps & Cloud
            ('Docker'), ('Kubernetes'), ('Jenkins'), ('GitLab CI/CD'),
            ('GitHub Actions'), ('AWS'), ('Azure'), ('Google Cloud Platform'),
            ...
            ('PyTorch'), ('Data Analysis'), ('Data Visualization'),
            ('Pandas'), ('NumPy'), ('Scikit-learn'),
            
            -- Other Technologies
            ('GraphQL'), ('REST API'), ('Microservices'), ('WebSockets'),
            ('gRPC'), ('OAuth'), ('JWT'), ('Socket.io'), ('RabbitMQ'), ('Kafka')
